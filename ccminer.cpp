...
int main(int argc, char *argv[])
{
	...
	printf("*** ccminer-JAD8 " PACKAGE_VERSION " for nVidia GPUs Contributed by protopool.net ***\n");
	if (!opt_quiet) {
		...
		printf("  Based on tpruvot@github project \n\n");
		printf("BTC donation address: 14nfgbnjTGzWJ4abHB2EbJ9rNCg2WrC8Ex \n\n");
	}
